...
<div class="container-login" style="height: 100vh;display: flex;align-items: center;justify-content: center;">
    <div class="login-container" style="height: 150px;">
        <div class="brand" style="margin-top: -75px">
            <div class="logo">
        ...
        <a href="<?php echo Helpers::getAdminRoute('setup/check'); ?>">
            <button class="login-submit">Install now</button>
        </a>
    </div>
</div>
