...
var chart3 = new Highcharts.chart('container-data-3', {
    chart: {
        type: 'area'
    },
    title: {
...
function resize() {
    ...
    chart3.setSize(document.querySelector("#container-data-3").offsetWidth, chart2.chartHeight, true);
}